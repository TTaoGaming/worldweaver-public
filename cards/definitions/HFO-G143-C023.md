# Kimi Code Harness
ID: HFO-G143-C023 · HARNESS
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

A Kimi-compatible tool harness with an explicit capability interface.
...
## Behavioral target
Verify harness and route compatibility; equipment does not grant authority.
