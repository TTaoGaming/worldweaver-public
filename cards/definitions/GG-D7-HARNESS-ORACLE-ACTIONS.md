# Oracle GitHub Actions Harness
ID: GG-D7-HARNESS-ORACLE-ACTIONS · HARNESS
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Oracle GitHub Actions Harness: a harness in the Harnesses / tools / models deck. Full source contract remains to be imported.
