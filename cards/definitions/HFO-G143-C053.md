# Brood Cycle
ID: HFO-G143-C053 · WORKFLOW
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Brood Cycle: a workflow in the Institution / topology / structures / workflows / force packages deck. Full source contract remains to be imported.
