# Drone Idle Sentinel
ID: GG-D9-DRONE-IDLE-SENTINEL · AGENT SKILL
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Drone Idle Sentinel: a agent skill in the Auras / Agent Skills / policies / behavioral modifiers deck. Full source contract remains to be imported.
