# Capacity Canary
ID: HFO-G143-C062 · WORKFLOW
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Capacity Canary: a workflow in the Institution / topology / structures / workflows / force packages deck. Full source contract remains to be imported.
