# Google API Steward Brood Mother
ID: GG-D3-GOOGLE-API-STEWARD · UNIT
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Google API Steward Brood Mother: a unit in the Valkyries / Hluti / named specialist units and vendor brood mothers deck. Full source contract remains to be imported.
