# Swarm Dispersion
ID: HFO-G143-C052 · WORKFLOW
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Swarm Dispersion: a workflow in the Institution / topology / structures / workflows / force packages deck. Full source contract remains to be imported.
