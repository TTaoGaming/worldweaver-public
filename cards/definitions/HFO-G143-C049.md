# Tao's Seal
ID: HFO-G143-C049 · AUTHORITY GATE
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

The explicit authority boundary for protected effects.
...
## Behavioral target
Bind approval to the actual effect and current scope; never infer it from a name.
