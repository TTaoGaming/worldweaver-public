# ChatGPT Text Tool-Calling Harness
ID: GG-D7-HARNESS-CHATGPT-TEXT · HARNESS
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

ChatGPT Text Tool-Calling Harness: a harness in the Harnesses / tools / models deck. Full source contract remains to be imported.
