# Vendor
ID: CORE-10 · ARCHETYPE
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

A provider relationship with distinct capacity, accounting and interfaces.
...
## Behavioral target
Keep provider capabilities separate from account readiness and permission.
