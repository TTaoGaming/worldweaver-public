# Receipt
ID: CORE-07 · PRIMITIVE
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

A source-bound record supporting a specific claim.
...
## Behavioral target
Check source, scope, revision and observation time before relying on a receipt.
