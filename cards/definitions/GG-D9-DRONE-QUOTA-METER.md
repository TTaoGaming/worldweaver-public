# Drone Quota Meter
ID: GG-D9-DRONE-QUOTA-METER · AGENT SKILL
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Drone Quota Meter: a agent skill in the Auras / Agent Skills / policies / behavioral modifiers deck. Full source contract remains to be imported.
