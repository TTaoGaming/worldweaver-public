# Lenovo Local Host
ID: GG-D8-LAND-LENOVO · LAND
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Lenovo Local Host: a land in the Lands / hosts / provider-account-capacity surfaces deck. Full source contract remains to be imported.
