# Drone Throttle Sentinel
ID: GG-D9-DRONE-THROTTLE-SENTINEL · AGENT SKILL
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Drone Throttle Sentinel: a agent skill in the Auras / Agent Skills / policies / behavioral modifiers deck. Full source contract remains to be imported.
