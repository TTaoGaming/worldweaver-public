# Boot Page
ID: HFO-G143-C047 · MANIFEST
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Boot Page: a manifest in the Institution / topology / structures / workflows / force packages deck. Full source contract remains to be imported.
