# Google API Project / Oracle Route
ID: GG-D8-LAND-GOOGLE-API · LAND
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Google API Project / Oracle Route: a land in the Lands / hosts / provider-account-capacity surfaces deck. Full source contract remains to be imported.
