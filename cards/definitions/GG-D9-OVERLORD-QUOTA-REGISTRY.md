# Overlord Quota Registry
ID: GG-D9-OVERLORD-QUOTA-REGISTRY · AGENT SKILL
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Overlord Quota Registry: a agent skill in the Auras / Agent Skills / policies / behavioral modifiers deck. Full source contract remains to be imported.
