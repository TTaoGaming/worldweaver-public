# Strangler Map
ID: HFO-G143-C060 · WORKFLOW
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Strangler Map: a workflow in the Institution / topology / structures / workflows / force packages deck. Full source contract remains to be imported.
