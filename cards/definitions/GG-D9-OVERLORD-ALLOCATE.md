# Overlord Allocate Skill
ID: GG-D9-OVERLORD-ALLOCATE · AGENT SKILL
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Overlord Allocate Skill: a agent skill in the Auras / Agent Skills / policies / behavioral modifiers deck. Full source contract remains to be imported.
