# Quota Daily Brief
ID: GG-D9-QUOTA-DAILY-BRIEF · AGENT SKILL
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Quota Daily Brief: a agent skill in the Auras / Agent Skills / policies / behavioral modifiers deck. Full source contract remains to be imported.
