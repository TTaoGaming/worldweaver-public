# Drone Waste Audit
ID: GG-D9-DRONE-WASTE-AUDIT · AGENT SKILL
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

Drone Waste Audit: a agent skill in the Auras / Agent Skills / policies / behavioral modifiers deck. Full source contract remains to be imported.
