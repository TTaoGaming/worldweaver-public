...
A checker for declared structural invariants.
...
## Behavioral target
Report what the check covers; structural validity does not prove runtime behavior.
