# Seat
ID: CORE-03 · PRIMITIVE
Definition: CANDIDATE / index. Runtime: UNVERIFIED. Behavior: NOT_TESTED.

A bounded role position that an actor may occupy.
...
## Behavioral target
Distinguish seat assignment from actor identity and its carrier.
